...
def test_job_definitions(training_api_client, organization_id, job_definition_id):
    adapter = JobDefinitions(api=training_api_client, organization_id=organization_id)
    assert adapter.organization_id == organization_id


def test_get_job_definition(requests_mock, api_base_url, training_api_client,
...
def test_create_job_definition(requests_mock, api_base_url, training_api_client,
                               organization_id, job_definition_id, job_definition_name,
                               training_job_definition_response, training_job_definition_version_response):
    adapter = JobDefinitions(api=training_api_client, organization_id=organization_id)
...
def test_archive_job_definition(requests_mock, api_base_url, training_api_client,
...
def test_unarchive_job_definition(requests_mock, api_base_url, training_api_client,
                                  organization_id, job_definition_id, job_definition_name) -> None:
    adapter = JobDefinitions(api=training_api_client, organization_id=organization_id)
...
def test_delete_job_definition(requests_mock, api_base_url, training_api_client,
                               organization_id, job_definition_id, job_definition_name) -> None:
    adapter = JobDefinitions(api=training_api_client, organization_id=organization_id)
...
def test_list_job_definitions(requests_mock, api_base_url, training_api_client,
                              organization_id, job_definition_id, job_definition_name,
...
def test_list_job_definitions_filter_archived(requests_mock, api_base_url, training_api_client,
                                              organization_id, job_definition_id, job_definition_name,
                                              training_job_definition_response) -> None:
    adapter = JobDefinitions(api=training_api_client, organization_id=organization_id)
...
def test_list_job_definitions_paging(requests_mock, api_base_url, training_api_client,
                                     organization_id, job_definition_id, job_definition_name,
                                     training_job_definition_response) -> None:
    adapter = JobDefinitions(api=training_api_client, organization_id=organization_id)
