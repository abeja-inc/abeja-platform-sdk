...
@pytest.fixture
def job_definition_factory(training_api_client, organization_id, job_definition_id, training_job_definition_response):
...
@pytest.fixture
def job_definition_version_factory(training_api_client, organization_id, job_definition_id, training_job_definition_version_response):
    def factory(organization_id=organization_id, job_definition_id=job_definition_id, **kwargs):
...
@pytest.fixture
def job_factory(training_api_client, organization_id, job_definition_id, job_id, job_response):
